...
lifts('loon', 'json', {
  "Children's Center Carpet": 'closed',
  "Kissin' Cousin Double": 'closed',
  "River's Edge Double": 'closed',
  ...
  'Seven Brothers Express Quad': 'closed',
  'Timbertown Quad': 'closed',
  'Tote Road Connector': 'closed',
  'White Mountain Express Gondola': 'closed'
});
