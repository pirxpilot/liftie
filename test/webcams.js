...
describe('webcams', function() {
  ...
  if (!process.env.WEBCAMS_DEV_ID) {
    ...
    it('should return webcams for valid location', function(done) {
      webcams({
        counter: 1,
        ll: [ -118.616810, 36.450008 ] // Mineral King
        ...
        webcam.should.have.property('name', 'Mineral King: Farewell Gap − Sequoia National Park');
        ...
        mobile.should.have.property('name', 'Mineral King: Farewell Gap − Sequoia National Park');
